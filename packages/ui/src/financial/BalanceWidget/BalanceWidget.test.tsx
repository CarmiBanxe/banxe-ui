...
describe('BalanceWidget', () => {
  it('renders total amount', () => {
    render(<BalanceWidget {...defaultProps} />)
  ...
  it('shows skeleton when loading', () => {
    render(<BalanceWidget {...defaultProps} loading />)
  ...
  it('shows error state when error prop set', () => {
    render(<BalanceWidget {...defaultProps} error />)
  ...
  it('renders GBP currency correctly', () => {
    render(<BalanceWidget {...defaultProps} currency="GBP" />)
    expect(screen.getByText(/GBP Balance/i)).toBeTruthy()
  })

  it('renders EUR currency correctly', () => {
    render(<BalanceWidget {...defaultProps} currency="EUR" total="2100.00" available="2100.00" pending="0.00" />)
