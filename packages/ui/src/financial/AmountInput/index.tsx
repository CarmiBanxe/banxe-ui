  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div
        ...
        `}
      >
        <span className="text-sm font-semibold text-secondary w-8 flex-shrink-0">
          {currency}
        </span>
        <input
          id={id}
          ...
          className="flex-1 bg-transparent font-mono text-xl font-bold text-primary outline-none placeholder:text-disabled"
        />
      </div>
      ...
      {available !== undefined && (
        <p
          id={hintId}
          className={`text-xs ${isOverBalance ? 'text-error' : 'text-secondary'}`}
        >
          {isOverBalance
